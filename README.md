# CI-CD-for-mern-in-Legal-App

### Group No: D6 - Group 06
### Project No: DO-17
...
This project implements a CI/CD (Continuous Integration and Continuous Deployment) pipeline for a mern-based Legal Application. The goal is to automate the process of building, testing, and deploying the application to ensure faster and more reliable software delivery.
...
This project demonstrates how to implement a CI/CD pipeline for a mern Legal Application using modern DevOps tools and practices. The pipeline automates key stages of the development lifecycle, including code integration, automated testing, and deployment.
...
* To implement a CI/CD pipeline for a mern Legal Application.
...
4.	MOKSH JAIN -	EN22CS301613
5.	MAYUSH JAIN -	EN22CS301594


## Conclusion
___
This project demonstrates the implementation of a CI/CD pipeline for a Mern Legal Application to automate the software development and deployment process. By integrating continuous integration and automated workflows, the project helps improve code quality, reduce manual effort, and ensure reliable application delivery. Overall, it highlights the importance of DevOps practices in making the development process faster, more efficient, and more consistent.

---
_Developed as part of the Skill Based Course at Medicaps University in collaboration with Datagami._
